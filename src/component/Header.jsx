...
const useStyles = makeStyles((theme) => ({
    root: {
        flexGrow: 1,
        display: "flex",
        background: "linear-gradient(90deg,rgba(75,6,193,7) 0%,rgba(206,2,189,1)100%)",
        height: "90.8vh",
        marginTop: '-20px',
    },
    sharp: {
    ...
    return (
        <Box component="section" className={classes.root}>
            <Box component="div" className={classes.leftSide}>
                ...
                <Typography variant="h4" > CopyWriter </Typography>
                <p>Enhance your communication with pshycology-based copywriting </p>
